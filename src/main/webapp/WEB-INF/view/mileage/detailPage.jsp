		...
		<div class="container">
			...
			<div class="tab_wrap3">
				<ul class="tab_head t4">
					...
					<li><a href="#none" onclick="toggleTab(2);"><span>상품 정보제공 고시</span></a></li>
					<li><a href="#none" onclick="toggleTab(3);"><span>연장/환불 안내</span></a></li>
				</ul>
								...
								<tbody>
									<tr>
										...
										<td>[연장]<br> * 상품정보에서 연장 가능한 상품인지 확인할 수 있습니다.<br> * 유효기간 이내에만 연장 가능하며, 기존 유효기간에서 3개월씩 최대 5년이내 연장 가능합니다.<br> * 쿠폰 유효기간 만료시 기간연장은 불가하며 환불만 가능합니다.<br> * 연장 방법<br>
											: 아시아나항공 홈페이지 &gt; 아시아나클럽 &gt; 마일리지사용몰 &gt; 마일리지사용몰 구매내역 &gt; 주문상세에서 직접 연장
										</td>
									</tr>
									<tr>
										<td>[환불]<br> * 쿠폰의 유효기간 이내에 사용하지 못하신 경우, 5년 이내에 환불이 가능하며 결제 금액의 100%를 환불해 드립니다.<br> * <span style="text-decoration: underline;">환불 시 유효기간이 만료된 마일리지는 자동 소멸</span> 되오니 주의 부탁
											드립니다.<br> * 환불 방법<br> - 쿠폰 유효기간 이내: 아시아나항공 홈페이지 &gt; 아시아나클럽 &gt; 마일리지사용몰 &gt; 마일리지사용몰 구매내역에서 직접 취소<br> - 쿠폰 유효기간 만료 및 연장된 쿠폰: 아시아나 고객센터 문의(1588-8180)
										</td>
									</tr>
									<tr>
