...
<main>
	...
	<div class="mileage--list">
		...
		<form action="mileageList" method="post"id="form">
			<div id="checkboxList">
				<input type="checkbox" class="searchKind" id="mileageType0" name="isAllSearch" value="true" /> 
				<label for="mileageType0">전체</label> 
				<input type="checkbox" class="searchKind" id="mileageType1"name="isUpSearch" value="true" /> 
				<label for="mileageType1">적립</label> 
				<input type="checkbox" class="searchKind" id="mileageType2" name="isUseSearch" value="true" /> 
				<label for="mileageType2">사용</label>
				<input type="checkbox" class="searchKind" id="mileageType3" name="isExpireSearch" value="true" /> 
			...
			<dl>
				<dt>조회기간</dt>
				<dd>
					<input type="radio" name="searchType" id="searchType1" value="P" checked="checked"/>
					<label for="searchType1">기간으로 조회</label> 
					<input type="radio" name="searchType" id="searchType2" value="R"/>
				...
				<dd>
					...
					<div class="relative_calendar">
						...
						<div class="calendar_layer">
							...
							<a href="#none" class="cal_status02">시작일</a> <a href="#none" class="cal_reset">
							<span class="hidden">달력 새로고침</span></a> <a href="#none" class="btn_cal_close">
					...
					<div class="relative_calendar">
						<div class="calendar_wrap">
							<input type="text" name="endTime" title="종료일" id="sCalendar02" class="datepicker input_cal" placeholder="종료일 선택" data-dateformat="y.mm.dd D" data-type="single_infinite_last">
							 <a href="#none"class="btn_airport type2 calendar_focus"></a>
						</div>
