			...
			<div class="prd_detail mar_to50">
				...
				<div class="prd_info">
					...
					<div class="mileage">
						...
						<p class="desc">
							<a href="#none" class="btn_arrow flow-action-login">로그인</a> 을 하시면
							마일리지를 확인하실 수 있습니다.
						</p>

					</div>
					<div class="dateinfo">
						<span class="date">2023-05-15 09:00 ~ 2023-05-22 08:59</span> <span
							class="deadline"><span class="num">7</span>일 남음</span>
					</div>
					...
					<form name="frmDefault" id="frmDefault" method="post" action="">
						<div class="select_area">
							...
							<div class="selected_prd 001" style="display: none;">
								<div class="tit">
									<p>
										[${shopProduct.brand}] ${shopProduct.name}<span class="type">[${shopProduct.brand}]
...
<script>
	...
	// 수량 증가 버튼 클릭 시
	document.querySelector('.btn_number.plus').addEventListener(
			'click',
			function() {
	...
	// 수량 감소 버튼 클릭 시
	document.querySelector('.btn_number.minus').addEventListener(
			'click',
			function() {
				let countInput = document
						.querySelector('input[name="selectedCount"]');
