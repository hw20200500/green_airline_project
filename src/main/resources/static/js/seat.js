...
// 항공기별 좌석 여백 세팅
if (airplaneId1 == 1) {
	$("#sch1Airplane .top--blank--div").css("height", "303px");
	$("#sch1Airplane .f--blank--div").css("height", "252px");
	$("#sch1Airplane .b--blank--div").css("height", "272px");
	$(".b--seat").css("margin-left", "88px");
	$(".e--seat").css("margin-left", "81px");
} else if (airplaneId1 == 2) {
	$("#sch1Airplane .top--blank--div").css("height", "605px");
	$("#sch1Airplane .b--blank--div").css("height", "235px");
} else if (airplaneId1 == 3) {
	$("#sch1Airplane .top--blank--div").css("height", "605px");
	$("#sch1Airplane .b--blank--div").css("height", "257px");
} else {
	$("#sch1Airplane .top--blank--div").css("height", "605px");
}

if (airplaneId2 == 1) {
	$("#sch2Airplane .top--blank--div").css("height", "303px");
	$("#sch2Airplane .f--blank--div").css("height", "252px");
	$("#sch2Airplane .b--blank--div").css("height", "272px");
} else if (airplaneId2 == 2) {
	$("#sch2Airplane .top--blank--div").css("height", "605px");
	$("#sch2Airplane .b--blank--div").css("height", "235px");
} else if (airplaneId2 == 3) {
	$("#sch2Airplane .top--blank--div").css("height", "605px");
	$("#sch2Airplane .b--blank--div").css("height", "257px");
} else {
	$("#sch2Airplane .top--blank--div").css("height", "605px");
}
