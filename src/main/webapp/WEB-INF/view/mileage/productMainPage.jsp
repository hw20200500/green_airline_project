...
height: 200px
	...
	<div class="container">
			...
			<c:forEach var="productList" items="${productList}">
				<div class="product_card" id="product">
					...
					<dl class="prd_info">
						...
						<dd>
							<div class="price">
								<span class="num">${productList.priceNumber()}</span> <span
									class="unit">마일</span>
							</div>
							<div class="date_info hidden"></div>
							<input type="hidden" value="${productList.count}"
								name="countName" class="count">
						</dd>
					</dl>
				</div>
			</c:forEach>
		...
		<!--/* 페이지네이션 렌더링 영역 */-->
		<div class="paging">
			<a href="/product/productMain?curPage=1">&laquo;</a> <a
				href="/product/productMain?curPage=${paging.curPage-1 }">&lt;</a>
			<c:forEach begin="${paging.firstPage }" end="${paging.lastPage }"
				var="i">
				<a href="/product/productMain?curPage=${i }"> 
			...
			<a href="/product/productMain?curPage=${paging.curPage+1 }">&gt;</a> <a
				href="/product/productMain?curPage=${paging.totalPageCount }">&raquo;</a>
...
<div class="announcement">
  ...
  <p><a href="http://gishow.kr/voc" class="link-button">쿠폰 수신내역 조회 및 재발송</a></p>
