	...
	<div>
				...
				<table border="1" class="table_list table_bag">
					...
					<tbody>
						<tr>
							<td>
								<div>
									<span class="baggage--kg--lbs">10kg(22lbs)</span> <span class="baggage--kg--lbs">10kg(22lbs)</span>
									<p>
							...
							<td>
								<div>
									<span class="baggage--kg--lbs">10kg(22lbs)</span>
									<p>
		...
		<div class="carryBaggage--note--class">
			...
			<ul>
				...
				<li>탑승구(Gate)에서는 수하물 위탁이 불가하오니, 기내 반입 휴대 수하물 규정을 반드시 준수하여 주십시오.
					<ul>
						<li><span>공항에서 인도받은 면세품</span>을 포함하여, 휴대하는 수하물의 크기와 무게가 기내 반입 규격을 초과하지 않도록 주의하여 주십시오.</li>
					</ul>
				</li>
				<li>아래의 물품 중 1개를 기내 반입 휴대수하물 외에 추가로 가져가실 수 있습니다.
					<ul>
						<li>소형서류가방</li>
						<li>핸드북</li>
						<li>노트북컴퓨터</li>
				...
				<li>기내 안전 및 승객 편의를 위해 비상구 또는 통로의 접근을 방해하거나 주변 승객에게 불편을 줄 수 있는 여행편의 용품은 <span>기내 사용이 불가</span>합니다. <br> 다만, 기내 휴대 수하물 허용 규격인 경우 <span>기내 반입은 가능</span>합니다.
					<ul>
				...
				<li>타 항공사로 연결 시&nbsp;해당 항공사의 기내&nbsp;휴대&nbsp;수하물 허용량 기준이 당사와 상이할 수 있습니다. <br> 각 항공사의 휴대 수하물 규정을 사전에&nbsp;확인하여주시기 바랍니다.
				</li>
			</ul>
		</div>
